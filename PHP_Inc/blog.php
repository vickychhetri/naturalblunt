<div class="blog">
        <div class="container">
            ...
            <div class="owl-carousel blog-carousel wow fadeInUp" data-wow-delay="0.1s">
              ...
              $product[3] = new Product("img/product/WALSPER_SUPERIOR_ACRYLIC_EMULSION-screen.png","Walsper Superior ACRYLIC Emulsion","Ecomate is a water-based exterior emulsion formulated with advanced ingredients and technology suitable to various climatic conditions. ","Walsper-Superior-Acrylic-Emulsion.php","⭐","Emulsion","5","unlimited");
