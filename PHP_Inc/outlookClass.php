        ...
        <div class="class">
            <div class="container">
                <div class="section-header text-center wow zoomIn" data-wow-delay="0.1s">
                    <p>Paint Co.</p>
                    <h2>Outlook of Modern Paints Produts </h2>
                </div>
                <div class="row">
                    <div class="col-12">
                        <ul id="class-filter">
                            <li data-filter="*" class="filter-active">Modern </li>
                            <li data-filter=".filter-1">INTERIOR</li>
                            <li data-filter=".filter-2">EXTERIOR</li>
                            <li data-filter=".filter-3">WOOD CARE</li>
                        </ul>
                    </div>
                </div>
