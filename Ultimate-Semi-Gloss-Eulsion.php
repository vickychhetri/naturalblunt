...
<body oncontextmenu="return false">
    ...
    <div class="container" style="margin-top:8%;">
        <!-- <br>
        <p class="text-center" style="font-size: 22px;font-weight:bold; color:black;"> Specially designed acrylic putty manufactured
            to offer white smooth finish, strength and
            durability to heat. This is highly useful for sealing cracks, holes, gaps, joints.</p>
        <hr> -->
                    ...
                    <article class="card-body p-5">
                        ...
                        <p class="price-detail-wrap">
                            <!-- <span class="price h3 text-warning">
                                <span class="currency">INR Rs.</span><span class="num">-</span>
                            </span> -->
                            <!-- <span>/</span> -->
                        </p> <!-- price-detail-wrap .// -->
                        <dl class="item-property">
                            ...
                            <dd>
                                <p style="text-align:justify;">
                                    Ultimate Semi Gloss Emulsion is a water-based, 100% pure acrylic resin emulsion paint. 
